...
happyReduction_1 ((HappyTerminal (NUMBER happy_var_4)) `HappyStk`
	_ `HappyStk`
...
happyNewToken action sts stk (tk:tks) =
	...
	LENGTH -> cont 30;
	WHILE -> cont 31;
	NUMBER happy_dollar_dollar -> cont 32;
	NAME happy_dollar_dollar -> cont 33;
	QCHAR happy_dollar_dollar -> cont 34;
	QString happy_dollar_dollar -> cont 35;
	_ -> happyError' (tk:tks)
	}
...
data Instruction = Declaration Type Var Expression
