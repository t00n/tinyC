...
testNASMGenerator = 
	describe "Generate NASM code" $ do
        ...
        it "Generates code for quicksort2.c" $ do
            ...
            let st = evalST ast
            let tac = tacGenerate st ast
            nasmGenerate st tac `shouldBe` NASMProgram [] []