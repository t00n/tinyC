...
main = hspec $ do
    ...
    describe "Generate NASM code" $ do
        ...
        it "Tests live variable analysis" $ do
            ...
            let ast = scan_and_parse "int a; int tiny() { int a = 5; if (a) { int b = 1 + a; } else { int c = 3; } } int f() { int a = 3 + 4; } int b = 3;"
            let st = symbolTable ast
            let tac = generateTAC ast
            controlFlowGraph (nasmGetText tac st) `shouldBe` Graph (S.fromList [(0,TACLabel "tiny"),(1,TACCopy "a" (TACInt 5)),(2,TACIf (TACExpr (TACVar "a") TACNotEqual (TACInt 0)) "l1"),(3,TACGoto "l2"),(4,TACLabel "l1"),(5,TACBinary "t1" (TACInt 1) TACPlus (TACVar "a")),(6,TACCopy "b" (TACVar "t1")),(7,TACGoto "l3"),(8,TACLabel "l2"),(9,TACCopy "c" (TACInt 3)),(10,TACLabel "l3"),(11,TACReturn Nothing),(12,TACLabel "f"),(13,TACBinary "t2" (TACInt 3) TACPlus (TACInt 4)),(14,TACCopy "a" (TACVar "t2")),(15,TACReturn Nothing)]) (S.fromList [(0,1),(1,2),(2,3),(2,4),(3,8),(4,5),(5,6),(6,7),(7,10),(8,9),(9,10),(10,11),(12,13),(13,14),(14,15)])
