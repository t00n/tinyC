...
main = hspec $ do
    ...
    describe "The generation of three-address-code" $ do
        ...
        it "Generates if" $ do
            ...
            generateTAC ast `shouldBe` [TACLabel "tiny",TACBinary "t1" (TACInt 1) TACGreater (TACInt 2),TACIf (TACVar "t1") "l1",TACGoto "l2",TACLabel "l1",TACDeclaration "a",TACCopy "a" (TACInt 5),TACCopy "a" (TACInt 3),TACLabel "l2",TACReturn (TACInt 0)]
        ...
        it "Generates a write" $ do
            ...
            generateTAC ast `shouldBe` [TACLabel "tiny",TACDeclaration "a",TACCopy "a" (TACInt 2),TACWrite (TACVar "a"),TACReturn (TACInt 0)]
